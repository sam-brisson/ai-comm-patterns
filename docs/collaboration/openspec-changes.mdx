...
<div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1.5rem'}}>
  <a href="https://github.com/users/sam-brisson/projects/2/views/1" target="_blank" rel="noopener noreferrer" className="button button--primary button--lg">
    Open Project Board →
  </a>
  <a href="https://github.com/sam-brisson/ai-comm-patterns/issues/new" target="_blank" rel="noopener noreferrer" className="button button--secondary button--lg">
    Create New Issue
  </a>
</div>
