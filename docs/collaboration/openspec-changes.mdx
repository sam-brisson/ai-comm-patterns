...
The captured conversation is submitted as a GitHub issue. Claude analyzes the transcript, identifies key decisions, and generates appropriate artifacts based on the label:
- **`propose`** — generates proposal.md, design.md, tasks.md and creates a PR
- **`explore`** — analyzes the conversation and posts insights as a comment
