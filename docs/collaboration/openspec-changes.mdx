...
Want to propose a new change or explore an idea? Use the project board below to create and track OpenSpec issues. Create an issue with a conversation transcript and label it `propose` or `explore` to kick off the process.

<div style={{width: '100%', border: '1px solid var(--ifm-color-emphasis-300)', borderRadius: '8px', overflow: 'hidden', marginBottom: '1.5rem'}}>
  <iframe
    src="https://github.com/users/sam-brisson/projects/2/views/1"
    title="OpenSpec Project Board"
