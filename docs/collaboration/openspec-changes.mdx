...
# OpenSpec: Self-Documenting Changes
...
The table below shows changes currently being developed using the OpenSpec process. Click any artifact to read it.
...
Here's what makes this interesting: **this very page was built using OpenSpec**.

The [TDD Knowledge Page](/docs/collaboration/openspec-changes) change you see in the table above? That started as a team conversation about how to standardize TDD practices. The conversation was processed, artifacts were generated, and now those artifacts are guiding the implementation.
...
Or just read through the active changes above to see real examples of AI-generated documentation from team conversations.
